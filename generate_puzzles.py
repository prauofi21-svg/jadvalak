...
# general-topic banks — deep fallback pool so a quota-starved day can still
# build a full set of clean puzzles
BUILTIN_EXTRA2 = {
    10: [("گربه", "حیوان خانگی میو"), ("اسب", "حیوان سواری و بارکش"),
         ("گوسفند", "دام پشمالو مزرعه"), ("مرغ", "پرندهٔ خانگی تخم‌گذار"),
         ("خروس", "مرغ بانگ‌آور سحر"), ("خرگوش", "جوندهٔ گوش‌بلند"),
         ("قورباغه", "دوزیست پرش‌کنندهٔ برکه"), ("پروانه", "حشرهٔ رنگین‌بال"),
         ("زنبور", "حشرهٔ عسل‌ساز"), ("مورچه", "حشرهٔ کوچک کوشا"),
         ("عقاب", "باز بزرگ آسمان"), ("کبوتر", "پرندهٔ اهلی نامه‌رسان"),
         ("ببر", "درندهٔ راه‌راه جنگل"), ("شیر", "پادشاه جنگل"),
         ("پلنگ", "درندهٔ خال‌دار"), ("روباه", "حیوان زیرک داستان‌ها"),
         ("غزال", "بازی چابک دشت")],
    11: [("چشم", "اندام بینایی"), ("دست", "اندام کار"),
         ("گوش", "اندام شنوا"), ("زبان", "اندام سخن"),
         ("دندان", "سفیدان جویدن"), ("قلب", "تپندهٔ سینه"),
         ("استخوان", "اسکلت تن"), ("خون", "مادهٔ سرخ رگ‌ها")],
    12: [("برنج", "دانهٔ سفید خوراک"), ("گندم", "دانهٔ آرد"),
         ("شکر", "شیرین‌کنندهٔ چای"), ("نمک", "طعم‌دهندهٔ دریایی"),
         ("روغن", "چربی مایع آشپزخانه"), ("گوشت", "پروتئین حیوانی سفره"),
         ("خربزه", "میوهٔ تابستانی رنگین"), ("هلو", "میوهٔ مخملی تابستان"),
         ("گیلاس", "میوهٔ سرخ کوچک بهاری"), ("لیمو", "میوهٔ ترش"),
         ("موز", "میوهٔ دراز گرمسیری"), ("بادام", "مغز درختی"),
         ("گردو", "مغز سخت‌پوست"), ("ماست", "فرآوردهٔ خوردهٔ شیر"),
         ("پنیر", "فرآوردهٔ نمکین شیر"), ("شربت", "نوشیدنی شیرین خنک"),
         ("بستنی", "خوراکی سرد تابستان")],
    13: [("میز", "چهارپایهٔ کار و خوراک"), ("صندلی", "جای نشستن با پشتی"),
         ("ساعت", "سنجشگر زمان"), ("چاقو", "ابزار برندهٔ آشپزخانه"),
         ("قاشق", "ابزار خوردن"), ("چنگال", "ابزار دندان‌دار سفره"),
         ("لیوان", "ظرف نوشیدنی"), ("بشقاب", "ظرف گرد غذا"),
         ("کتری", "ظرف جوش آب"), ("سماور", "کتری سنتی چای"),
         ("ترازو", "سنجشگر وزن"), ("قیچی", "ابزار برندهٔ پارچه"),
         ("سوزن", "ابزار دوخت"), ("میخ", "میل فلزی کوبیده"),
         ("شمعدان", "پایهٔ شمع"), ("تشک", "بستر نرم خواب"),
         ("پرده", "پوشش پنجره"), ("قفل", "بندکنندهٔ در"),
         ("تیر", "تک‌چوب بام"), ("کاشی", "پوشش رنگین دیوار"),
         ("چراغ", "منبع نور خانه"), ("کلاه", "پوشش سر"),
         ("جوراب", "پوشش پا"), ("دستکش", "پوشش دست"),
         ("شال", "پوشش گردن و شانه"), ("لباس", "پوشش تن"),
         ("شلوار", "پوشش پای تن"), ("دامن", "پوشش پای زنانه")],
    14: [("پزشک", "درمانگر تن"), ("پرستار", "همراه بیمار"),
         ("معلم", "آموزندهٔ مدرسه"), ("نقاش", "آفرینندهٔ رنگ و نقش"),
         ("خواننده", "صداپیشهٔ آهنگ"), ("بازرگان", "سوداگر بازار"),
         ("کشاورز", "کارگر کشت و کار"), ("خیاط", "دوزندهٔ لباس"),
         ("راننده", "فرمان‌دار خودرو"), ("سرباز", "عضو ارتش"),
         ("شهر", "سکونتگاه بزرگ مردم"), ("روستا", "سکونتگاه کوچک کشاورز"),
         ("بازار", "محل خرید و فروش"), ("مدرسه", "خانهٔ آموزش"),
         ("کارگاه", "محل ساخت و تولید")],
    15: [("اندیشه", "کار ذهن"), ("خیال", "سیمای ذهن"),
         ("امید", "انتظار خوش"), ("ترس", "هراس"),
         ("عشق", "دل‌بستگی"), ("دوستی", "مهربانی میان دو نفر"),
         ("دانش", "شناخت آموخته"), ("خرد", "عقل"),
         ("قدرت", "توان بالا"), ("ثروت", "دارایی فراوان"),
         ("دارو", "شفادهندهٔ بیمار"), ("درمان", "کار پزشک"),
         ("صبح", "آغاز روز"), ("ظهر", "اوج خورشید"),
         ("عصر", "پس‌از نیم‌روز"), ("دیروز", "روز پیش"),
         ("فردا", "روز پس"), ("قرن", "صد سال"),
         ("دهه", "ده سال"), ("لحظه", "دمی کوتاه")],
}
for _k, _extra in BUILTIN_EXTRA2.items():
    _have = {w for w, _ in BUILTIN.get(_k, [])}
    BUILTIN.setdefault(_k, []).extend(
        (w, c) for w, c in _extra if w not in _have)
